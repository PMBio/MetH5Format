    ...
    def test_create_h5(self):
        with TemporaryFile() as tmp_f:
            ...
            with MetH5File(tmp_f, "w", chunk_size=10) as mf:
                mf.parse_and_add_nanopolish_file(self.datadir.joinpath("nanopolish_calls.tsv.gz"))
            ...
            with MetH5File(tmp_f, "r", chunk_size=10) as mf:
                ...
                matrix_container = value_container.to_sparse_methylation_matrix(read_groups_key="test_group")
                ...
                # ---- Access region-wise: ----
                value_container = chrom_container.get_values_in_range(97732352, 97745195)
                ...
                sub_matrix = matrix_container.get_submatrix_from_read_mask(matrix_container.read_samples == 1)
                ...
                two_sample_matrix = create_sparse_matrix_from_samples(
                    {"A": value_container, "B": value_container}, sample_prefix_readnames=True,
                )
                ...
                self.assertEqual(value_container.get_llr_site_median()[0].shape[0], 184)
